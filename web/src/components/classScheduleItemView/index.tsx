...
const ClassScheduleItemView: React.FC<CSIVProps> = ({ userId, teacherId,classSchedule }) => {
        ...
        <div id={styles.classScheduleItem}>
            ...
            <div id={styles.time}>
                <div id={styles.fromItem}>
                    <p>De:</p>
                    <label>{classSchedule.from}</label>
                </div>
                <div id={styles.toItem}>
                    <p>Até:</p>
                    <label>{classSchedule.to}</label>
                </div>
            </div>
            <button 
                className={styles.solicitar}
